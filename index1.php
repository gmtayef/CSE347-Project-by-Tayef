        ...
        <div class="relative z-10 container mx-auto px-4 h-full flex flex-col">
            <nav class="py-6 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php else: ?>
                        <a href="login_form.php" class="bg-transparent border border-white text-white py-2 px-4 rounded-lg hover:bg-white hover:text-black transition">Login</a>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <?php else: ?>
                                    <a href="login_form.php" class="bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-gray-600 transition">Login to Enroll</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
